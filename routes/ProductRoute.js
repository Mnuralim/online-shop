...
import { addToWishlist, createProduct, deleteProduct, getAllProducts, getProduct, rating, updateProduct } from "../controllers/Product.js";
import { adminOnly, authMidleware } from "../middleware/AuthMidleware.js";
import { upload } from "../middleware/uploadImages.js";

const router = express.Router();

// router.post("/create-product", authMidleware, adminOnly, upload.array("images", 10), createProduct);
router.post("/create-product", authMidleware, adminOnly, createProduct);
router.get("/get-product/:id", getProduct);
router.get("/get-all-products/", getAllProducts);
router.put("/update-product/:id", authMidleware, adminOnly, upload.array("images", 10), updateProduct);
